...
for outDoorActivities in  movements {
    print(outDoorActivities)
}
...
for (typeOfExcerise, heartRate) in movementHeartRates {
    print("your heart rate after \(typeOfExcerise) is \(heartRate)")
}
/*:
