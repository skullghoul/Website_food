...
var xRunning = RunningWorkout(distance: 3200, time: 1, elevation: 12)
print(xRunning.averageMileTime)
/*:
...
var xCodeBox = Steps(steps: 9_999, goal: 10_000)
xCodeBox.takeStep()
print(xCodeBox.steps)
/*:
