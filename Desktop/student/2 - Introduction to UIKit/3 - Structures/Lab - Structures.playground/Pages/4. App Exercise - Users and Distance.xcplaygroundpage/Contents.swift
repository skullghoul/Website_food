...
var zander = User(name: "Zander", age: 17, height: 6, weight: 150, activityLevel: 7)

print("This users name is \(zander.name) they are \(zander.age) and have an active level of \(zander.activityLevel) they weigh \(zander.weight) and are \(zander.height) foot")
/*:
...
print(Distance.self.init(meters: 1600))
      print(Distance.self.init(feet: 5249.344))
//:  Now create an instance of `Distance` called `mile`. Use the initializer for meters to set the distance to 1600. Print out the property for feet and verify that it is equal to 5249.344.
var mile = Distance.init(feet: 5249.344)
print(mile)
//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
var more = Distance.init(meters: 12)
print(more)
